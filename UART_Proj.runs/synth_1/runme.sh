...
HD_PWD='C:/Users/moosa/OneDrive/Desktop/College Stuff/Engineering/VHDL/UART_Proj/UART_Proj.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log interface_ff_bench.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source interface_ff_bench.tcl
