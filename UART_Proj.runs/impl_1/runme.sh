...
HD_PWD='C:/Users/moosa/OneDrive/Desktop/College Stuff/Engineering/VHDL/UART_Proj/UART_Proj.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log interface_ff_bench.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source interface_ff_bench.tcl -notrace
